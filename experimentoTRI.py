...
for r, p in enumerate(porcentagem):
    ...
    for k in np.arange(10):
        ...
        self1 = TriTraining('MLP', mlp)
        self2 = TriTraining('KNN', knn)
        self3 = TriTraining('SVM', svm)
        self4 = TriTraining('RF', rf)
        self5 = TriTraining('NB', nb)
        self6 = TriTraining('LR', lr)
    ...
    resultadoMLP.to_csv('resultados/resultado_TRI_MLP_'+str(rotulados[r])+'.csv', index=False)
    resultadoKNN.to_csv('resultados/resultado_TRI_KNN_'+str(rotulados[r])+'.csv', index=False)
    resultadoSVM.to_csv('resultados/resultado_TRI_SVM_'+str(rotulados[r])+'.csv', index=False)
    resultadoRF.to_csv('resultados/resultado_TRI_RF_'+str(rotulados[r])+'.csv', index=False)
    resultadoNB.to_csv('resultados/resultado_TRI_NB_'+str(rotulados[r])+'.csv', index=False)
    resultadoLR.to_csv('resultados/resultado_TRI_LR_'+str(rotulados[r])+'.csv', index=False)
    
    resultadoMLP_T.to_csv('resultados/resultado_TRI_MLP_T'+str(rotulados[r])+'.csv', index=False)
    resultadoKNN_T.to_csv('resultados/resultado_TRI_KNN_T'+str(rotulados[r])+'.csv', index=False)
    resultadoSVM_T.to_csv('resultados/resultado_TRI_SVM_T'+str(rotulados[r])+'.csv', index=False)
    resultadoRF_T.to_csv('resultados/resultado_TRI_RF_T'+str(rotulados[r])+'.csv', index=False)
    resultadoNB_T.to_csv('resultados/resultado_TRI_NB_T'+str(rotulados[r])+'.csv', index=False)
    resultadoLR_T.to_csv('resultados/resultado_TRI_LR_T'+str(rotulados[r])+'.csv', index=False)